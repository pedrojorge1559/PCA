...
def process_images(image_list):
    ...
    for img in image_list:
        img = img.resize((128, 128))  # Redimensionar
        img = img.convert('L')  # Converter para tons de cinza
        img = np.array(img).flatten()  # Achatar a imagem
...
# Salvar dataframe antes da classificação
...
# Salvar dataframe após a classificação
